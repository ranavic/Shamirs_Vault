            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem' }}>
                ...
                <div style={{ display: 'flex', gap: '0.5rem' }}>
                    <button
                        ...
                        style={{ padding: '4px 8px', fontSize: '0.8rem', background: '#f44336', color: 'white', border: 'none' }}
                    >
                        Clear
                    </button>
                    <label style={{
                            ...
                            onChange={(e) => {
                                ...
                                reader.onload = (ev) => {
                                    try {
                                        ...
                                        if (json.vault) setVaultData(json.vault);
                                        if (json.shares && Array.isArray(json.shares)) {
                                            setShareInputs(json.shares);
                                        }
                                    } catch (err) {
                                        setError("Failed to parse Vault Kit file.");
                                    }
                                };
